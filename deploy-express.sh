...
# 配置参数（可通过环境变量覆盖）
CONTAINER_NAME="${CONTAINER_NAME:-my-express-service}"          # 容器名称
IMAGE_NAME="${IMAGE_NAME:-crpi-omc65ozz650fnfe9.cn-shanghai.personal.cr.aliyuncs.com/jackson_chen/my-express-app}"  # 镜像地址
IMAGE_TAG="${IMAGE_TAG:-latest}"                       # 镜像标签
PORT_MAPPING="${PORT_MAPPING:-8089:3000}"                  # 端口映射
